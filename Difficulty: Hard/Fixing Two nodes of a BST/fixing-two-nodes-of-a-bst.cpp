...
class Solution {
public:
    // Helper function to perform an inorder traversal and find the two swapped nodes.
    void correctBSTUtil(Node* root, Node*& prev, Node*& first, Node*& middle, Node*& last) {
        ...
        // If previous node is greater than the current node, it's a violation.
        if (prev != nullptr && root->data < prev->data) {
            ...
            if (first == nullptr) {
                ...
                // If it's the second violation, mark 'last'
                last = root;
            }
        }
    ...
    void correctBST(Node* root) {
        ...
        // If two non-adjacent nodes are swapped, then 'first' and 'last' will be set.
        if (first && last)
            swap(first->data, last->data);
        // If the swapped nodes are adjacent in the inorder traversal, only 'first' and 'middle' will be set.
